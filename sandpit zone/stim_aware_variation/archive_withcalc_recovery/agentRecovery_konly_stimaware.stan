...
model{
  ...
  for(atrial in 1:hm_trials){
	...
	est_trial_option_attribute[atrial,anoption,anattribute]~normal(truth_trial_option_attribute[atrial,anoption,anattribute],0.5); //was N(0,1). This is where you'd end up from that prior after one observation right on the truth. (I think?)
      }
    }
  }
