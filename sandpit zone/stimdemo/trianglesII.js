...
function recordResponse(responseType,stimsummary,stimid){
    ...
    document.getElementById("plot"+stimid).style.visibility="visible";
    document.getElementById("caption"+stimid).innerHTML="You chose: "+responseType;
...
//)//end shuffle stimlist
     ...
     for(var i =0;i<stimlist.length;i++){
 	 document.write("<div style='border:5px solid green; width:100%; text-align:right'> <div class='stimholder' id='stimholder"+i+"'></div><div><img id='plot"+stimlist[i].stimid+"' width=500 height=500 src='img/demofit_trial"+(i+1)+".png'><p id='caption"+stimlist[i].stimid+"'>Which is largest?</p></div></div><br/><br/>");
