...
for(arecovery in list.files("recovery/",pattern=".*RData")){
    ...
    if(saveplots){
        ggsave(k.violins.plot+ggtitle(paste0(hm.attractionstim," attraction stimuli of ",sum(mydata.df$ppntid==1)) ),
