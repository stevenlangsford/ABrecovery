...
hm_options=3; #ugh sorry
hm_ppnts=max(simexp.df$ppntid) #how the f did this end up being wrong?
...
save.image(file="regression_recovery.RData")
View("done regressing")
