...
model{
  ...
  for(atrial in 1:hm_trials){
	...
	if(anattribute % 2 == 0) est_trial_option_attribute[atrial,anoption,anattribute]~normal(0,1); //??
	else est_trial_option_attribute[atrial,anoption,anattribute]~uniform(-3,3); //?
      }
    }
  }
